    ...
    def _fake_translate(item):
        return {
            ...
            "body": ("متن کامل فارسی درباره لیورپول که برای تست به اندازه کافی "
                     ...
                     "اطلاعات اصلی خبر باشد. مذاکرات ادامه دارد و هر لحظه ممکن "
                     "است جزئیات تازه‌ای درباره رقم نهایی و ساختار پرداخت "
                     "منتشر شود. منابع نزدیک به باشگاه تأکید کرده‌اند که توافق "
                     "هنوز قطعی نشده و روزهای آینده تعیین‌کننده است."),
            "importance": "normal",
            "tags": [],
            "provider": "test",
        }
